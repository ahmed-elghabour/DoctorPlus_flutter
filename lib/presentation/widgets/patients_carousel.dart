...
List<List<String>> chunkedImgList(List<String> list, int chunkSize) {
...
class _PatientsCarouselState extends State<PatientsCarousel> {
  ...
  Widget build(BuildContext context) {
    List<List<String>> chunkedImages = chunkedImgList(imgList, 4);
    List<Widget> imageSliders = chunkedImages.map((chunk) {
      return Column(
    ...
    return Column(
      children: [
        ...
        Row(
          ...
          children: chunkedImages.asMap().entries.map((entry) {
