...
class DoctorService {
  static final CollectionReference reservations = FirebaseFirestore.instance.collection('appointments');

  static Stream<List<dynamic>>? getReservations(String doctorId, String datePicked) {
    ...
    .snapshots();
     ...
     return reservationsStream.map((QuerySnapshot query) {
      final List<Map<String, dynamic>> filteredAppointments = query.docs
